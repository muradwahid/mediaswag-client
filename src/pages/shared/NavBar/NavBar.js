		...
		<header className='bg-white shadow-md py-2'>
			<nav className='w-4/5 mx-auto flex justify-between items-center'>
				<div className='flex gap-8 text-[22px] items-center'>
					...
					<p><i className="fa-solid fa-message text-emerald-600"></i></p>
				...
				<Link to="/" className={`lg:pr-[190px] ${search ? 'lg:pr-[190px]' : "pr-[200px]"}`}>
					<i className="fa-solid fa-house text-[22px] text-emerald-600"></i>
				</Link>
			...
			</nav>
			{
				profileModal ? <div className='absolute right-20 top-24 w-80 bg-emerald-200 px-6 py-7 rounded-2xl '>
					...
					<div className='text-center mt-4'>
						<Link to={`/profile/${user?.email}`} className='bg-gradient-to-t from-emerald-900 to-emerald-500 rounded px-3 py-2 text-gray-100 '>View Profile</Link>
					</div>
					<div className='mt-8'>
